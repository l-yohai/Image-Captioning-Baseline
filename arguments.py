...
class ModelArguments:
    ...
    decoder_model_name_or_path: str = field(
        default="gpt2",
        metadata={
            "help": "Path to pretrained decoder model or model identifier from huggingface.co/models"},
    )
...
class CaptionTrainingArguments(Seq2SeqTrainingArguments):
    ...
    logging_steps: int = field(default=1000, metadata={
                               "help": "Log every X updates steps."})
    save_steps: int = field(default=1000, metadata={
                            "help": "Save checkpoint every X updates steps."})
    eval_steps: int = field(default=1000, metadata={
